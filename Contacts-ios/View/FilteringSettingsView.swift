...
extension FilteringSettingsView {
    ...
    private func addSubviews() {
        settingsStackView.addArrangedSubview(makeSettingsView(text: UICreator.shared.makeLabel(text: "Выбрать все", alignment: .left),
                                                              andCheckbox: selectAllCheckbox))
        settingsStackView.addArrangedSubview(makeSettingsView(withImage: makeSettingsIcon(named: K.IconsNames.telegramIcon),
                                                              text: UICreator.shared.makeLabel(text: "Telegram", alignment: .left),
                                                              andCheckbox: telegramCheckbox))
        settingsStackView.addArrangedSubview(makeSettingsView(withImage: makeSettingsIcon(named: K.IconsNames.whatsAppIcon),
                                                              text: UICreator.shared.makeLabel(text: "WhatsApp", alignment: .left),
                                                              andCheckbox: whatsAppCheckbox))
        settingsStackView.addArrangedSubview(makeSettingsView(withImage: makeSettingsIcon(named: K.IconsNames.viberIcon),
                                                              text: UICreator.shared.makeLabel(text: "Viber", alignment: .left),
                                                              andCheckbox: viberCheckbox))
        settingsStackView.addArrangedSubview(makeSettingsView(withImage: makeSettingsIcon(named: K.IconsNames.signalIcon),
                                                              text: UICreator.shared.makeLabel(text: "Signal", alignment: .left),
                                                              andCheckbox: signalCheckbox))
        settingsStackView.addArrangedSubview(makeSettingsView(withImage: makeSettingsIcon(named: K.IconsNames.threemaIcon),
                                                              text: UICreator.shared.makeLabel(text: "Threema", alignment: .left),
                                                              andCheckbox: threemaCheckbox))
        settingsStackView.addArrangedSubview(makeSettingsView(withImage: makeSettingsIcon(named: K.IconsNames.phoneIcon),
                                                              text: UICreator.shared.makeLabel(text: "Номер телефона", alignment: .left),
                                                              andCheckbox: phoneCheckbox))
        settingsStackView.addArrangedSubview(makeSettingsView(withImage: makeSettingsIcon(named: K.IconsNames.eMailIcon),
    ...
    private func makeSettingsView(withImage image: UIImageView? = nil, text: UILabel, andCheckbox checkbox: UIImageView) -> UIView {
