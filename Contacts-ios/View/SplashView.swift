...
final class SplashView: UIView {
    ...
    private let logoIcon: UIImageView = UICreator.shared.makeImageView(withImage: UIImage(named: K.IconsNames.practicumIcon))
    let accessSettingsButton: UIButton = UICreator.shared.makeButton(withTitle: "Хочу увидеть свои контакты", backgroundColor: .ypBlue, cornerRadius: 24, action: #selector(accessSettingsButtonTapped))
